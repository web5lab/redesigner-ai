...
const Navbar = () => {
  ...
  return (
    <header className="transition-all duration-300 bg-slate-900/95 backdrop-blur-md shadow-lg">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <div className="flex items-center">
            <Link href="/" className="flex items-center gap-2 text-indigo-400 font-bold text-xl">
              <Image src="/logo.webp" alt="Logo" width={40} height={40} className="h-10 w-10" />
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="lg:hidden mt-2 pb-4 border-t border-slate-700">
            <nav className="pt-4">
