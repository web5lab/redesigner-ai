...
const Login = () => {
  ...
  const handleGithubLogin = () => {
    window.location.href = `${process.env.VITE_SERVER_URL}/auth/github`
  }
      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-2 text-indigo-400 font-bold text-2xl mb-4">
            <Image src="/logo.webp" alt="Logo" width={48} height={48} className="h-12 w-12" />
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-slate-400">
              ...
              <a href="/terms-of-service" className="text-indigo-400 hover:text-indigo-300">Terms of Service</a>
              {' '}and{' '}
              <a href="/privacy-policy" className="text-indigo-400 hover:text-indigo-300">Privacy Policy</a>
            </p>
          </div>
        </div>
