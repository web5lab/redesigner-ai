...
const Preview = ({viewport}) => {
  ...
  return (
    ...
    <div className="h-full w-full relative flex flex-col items-center justify-center p-4">
      {/* Iframe container */}
      <div
        className={`mx-auto transition-all rounded-lg duration-300 ease-in-out bg-white overflow-hidden
                    ${viewport !== 'desktop' ? 'border-2 border-slate-600 shadow-2xl rounded-lg':'' }
