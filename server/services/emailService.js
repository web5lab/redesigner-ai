        ...
        const mailOptions = {
            ...
            html: `
                ...
                <head>
                    <meta charset="utf-8">
                    <meta name="viewport" content="width=device-width, initial-scale=1.0">
                    <title>Welcome - CustomerBot</title>
                </head>
                <body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f8fafc;">
                    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                        ...
                        <div style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); padding: 40px 30px; text-align: center;">
                            ...
                            <h1 style="color: #ffffff; margin: 0 0 10px 0; font-size: 28px; font-weight: 700;">Welcome Aboard!</h1>
                            <p style="color: #d1fae5; margin: 0; font-size: 16px;">You're now part of ${botName}</p>
                        </div>
                        ...
                        <div style="padding: 40px 30px;">
                            ...
                            <div style="background: linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%); border: 1px solid #bae6fd; border-radius: 8px; padding: 25px; margin: 0 0 30px 0;">
                                <p style="color: #374151; line-height: 1.6; margin: 0 0 15px 0; font-size: 16px;">
                                    🎊 Congratulations! You've successfully joined the <strong style="color: #1f2937;">${botName}</strong> team as a 
                                    <strong style="color: #1f2937;">${role}</strong>.
                                </p>
                                <p style="color: #374151; line-height: 1.6; margin: 0; font-size: 16px;">
                                    You can now access the bot dashboard and start collaborating with your team members.
                                </p>
                            </div>
                            ...
                            <div style="margin: 0 0 30px 0;">
                                ...
                                <div style="display: grid; gap: 15px;">
                                    <div style="display: flex; align-items: flex-start; gap: 15px;">
                                        <div style="width: 32px; height: 32px; background-color: #dbeafe; border-radius: 8px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                                            <span style="color: #3b82f6; font-weight: 700; font-size: 14px;">1</span>
                                        </div>
                                        <div>
                                            <h4 style="color: #1f2937; margin: 0 0 5px 0; font-size: 16px; font-weight: 600;">Explore the Dashboard</h4>
                                            <p style="color: #6b7280; margin: 0; font-size: 14px;">Familiarize yourself with the bot interface and available features.</p>
                                        </div>
                                    </div>
                                    
                                    <div style="display: flex; align-items: flex-start; gap: 15px;">
                                        <div style="width: 32px; height: 32px; background-color: #dcfce7; border-radius: 8px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                                            <span style="color: #16a34a; font-weight: 700; font-size: 14px;">2</span>
                                        </div>
                                        <div>
                                            <h4 style="color: #1f2937; margin: 0 0 5px 0; font-size: 16px; font-weight: 600;">Review Your Permissions</h4>
                                            <p style="color: #6b7280; margin: 0; font-size: 14px;">Check what actions you can perform based on your ${role} role.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div style="display: flex; align-items: flex-start; gap: 15px;">
                                        <div style="width: 32px; height: 32px; background-color: #fef3c7; border-radius: 8px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                                            <span style="color: #d97706; font-weight: 700; font-size: 14px;">3</span>
                                        </div>
                                        <div>
                                            <h4 style="color: #1f2937; margin: 0 0 5px 0; font-size: 16px; font-weight: 600;">Start Collaborating</h4>
                                            <p style="color: #6b7280; margin: 0; font-size: 14px;">Begin working with your team to improve the bot's performance.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 20px;">
                                <h4 style="color: #1f2937; margin: 0 0 10px 0; font-size: 16px; font-weight: 600;">Team Information</h4>
                                <div style="display: grid; gap: 8px;">
                                    <div style="display: flex; justify-content: space-between;">
                                        <span style="color: #6b7280; font-size: 14px;">Bot Name:</span>
                                        <span style="color: #1f2937; font-weight: 600; font-size: 14px;">${botName}</span>
                                    </div>
                                    <div style="display: flex; justify-content: space-between;">
                                        <span style="color: #6b7280; font-size: 14px;">Your Role:</span>
                                        <span style="color: #1f2937; font-weight: 600; font-size: 14px; text-transform: capitalize;">${role}</span>
                                    </div>
                                    <div style="display: flex; justify-content: space-between;">
                                        <span style="color: #6b7280; font-size: 14px;">Joined:</span>
                                        <span style="color: #1f2937; font-weight: 600; font-size: 14px;">${new Date().toLocaleDateString()}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="background-color: #f8fafc; border-top: 1px solid #e2e8f0; padding: 25px 30px; text-align: center;">
                            ...
                            <div style="margin: 0 0 15px 0;">
                                <a href="mailto:support@customerbot.ai" style="color: #3b82f6; text-decoration: none; font-weight: 600; font-size: 14px; margin-right: 20px;">
                                    Contact Support
                                </a>
                                <a href="${process.env.VITE_WEB_URL}/docs" style="color: #3b82f6; text-decoration: none; font-weight: 600; font-size: 14px;">
                                    View Documentation
                                </a>
                            </div>
                            <p style="color: #9ca3af; margin: 0; font-size: 12px;">
