    ...
    <section className="py-24 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative">
              <div className="text-center">
                <div className={`w-12 h-12 sm:w-16 sm:h-16 ${step.color} rounded-lg flex items-center justify-center mx-auto mb-4 sm:mb-6`}>
        ...
        <div className="text-center mt-16">
          <button className="bg-gray-900 hover:bg-gray-800 text-white px-6 sm:px-8 py-3 rounded-lg font-medium transition-all">
